 ...
 * @subpackage Chrx_Post_Cars/admin
 */
...
class Chrx_Post_Cars_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $chrx_post_cars       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->chrx_post_cars, plugin_dir_url( __FILE__ ) . 'css/chrx-post-cars-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->chrx_post_cars, plugin_dir_url( __FILE__ ) . 'js/chrx-post-cars-admin.js', array( 'jquery' ), $this->version, false );
